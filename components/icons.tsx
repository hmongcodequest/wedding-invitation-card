...
export function PaletteIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M12 22a10 10 0 1 1 10-10c0 2.21-1.79 3-3 3h-2.5a2.5 2.5 0 0 0-1.9 4.1c.4.5.4 1.2 0 1.7-.5.7-1.6 1.2-2.6 1.2Z" />
...
export function SpinnerIcon(props: IconProps) {
  return (
    <svg {...base(props)} className="spin" role="status" aria-label="ກຳລັງດຳເນີນການ">
...
export function BrideIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <circle cx="12" cy="8" r="4" />
      <path d="M12 12c-4 0-7 2.5-7 6v2h14v-2c0-3.5-3-6-7-6Z" />
      <path d="M12 4v1M10.5 5.5h3" />
    </svg>
  );
}

export function GroomIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <circle cx="12" cy="8" r="4" />
      <path d="M12 12c-4 0-7 2.5-7 6v2h14v-2c0-3.5-3-6-7-6Z" />
      <path d="M12 4v2M11 5h2" />
    </svg>
  );
}
